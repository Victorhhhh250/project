      ...
      >
        <div className="flex h-full items-center justify-between px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="flex items-center gap-3.5 min-w-0">
            <button type="button" onClick={() => setSidebarOpen(true)} aria-label="Abrir menu"
            ...
            <div className="flex flex-col justify-center min-w-0">
              <div className="hidden sm:flex items-center gap-1.5 text-[11px] font-medium tracking-wide">
                <span className="font-semibold text-slate-500">ATLHON</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button type="button" onClick={() => setSearchOpen(true)}
              className="hidden md:flex h-9 items-center gap-3 px-3.5 md:w-56 lg:w-72 xl:w-80 rounded-xl border border-slate-200/90 bg-slate-50/70 hover:bg-white hover:border-blue-300 hover:shadow-sm transition-all group focus:outline-none cursor-pointer"
              aria-label="Abrir busca global">
              <Search size={15} className="text-slate-400 group-hover:text-blue-600 transition-colors flex-shrink-0" />
            ...
            <button type="button" onClick={() => setSearchOpen(true)} aria-label="Buscar"
              className="md:hidden h-9 w-9 flex items-center justify-center rounded-xl text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors cursor-pointer">
              <Search size={19} />
            </button>
